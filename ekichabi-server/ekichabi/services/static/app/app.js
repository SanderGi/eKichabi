...
angular.module('ussdClient',[]).controller('MainController',['$scope','$http', 'ussdDjango', function($scope,$http,django) {
  ...
  var initial_data = function() {
    return {
      ...
      sessionId:django.transport+"AT_____" + Math.floor(Math.random()*999999),
      text:""
    }
  }
